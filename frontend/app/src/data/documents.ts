...
export const documents: DocumentItem[] = [
  // ——— Front-end (HTML/CSS) ———
  { type: 'html-css', category: 'slide', title: 'Conteúdo', desc: 'HTML, web, marcação.', path: path('frontend/slides-conteudo-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'Listas e formulários', desc: 'Listas e formulários.', path: path('frontend/slides-listas-formularios-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'Estrutura de projeto', desc: 'Pastas e arquivos.', path: path('frontend/slides-estrutura-projeto-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'Revisão HTML e CSS', desc: 'Revisão HTML e CSS.', path: path('frontend/slides-revisao-html-css-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'CSS: camada de estilo', desc: 'CSS camada de estilo.', path: path('frontend/slides-css-camada-estilo-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'Box model e grid', desc: 'Box model e grid.', path: path('frontend/slides-box-model-grid-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'Flexbox', desc: 'Flexbox.', path: path('frontend/slides-flexbox-corrigido.md') },
  { type: 'html-css', category: 'slide', title: 'Landing page', desc: 'Landing page.', path: path('frontend/slides-landing-page-corrigido.md') },
  { type: 'html-css', category: 'readme', title: 'README (geral)', desc: 'Visão geral dos documentos Front-end.', path: path('frontend/README.md') },
  { type: 'html-css', category: 'readme', title: 'README conteúdo', desc: 'Resumo das correções: slides conteúdo.', path: path('frontend/README-slides-conteudo.md') },
  { type: 'html-css', category: 'readme', title: 'README listas e formulários', desc: 'Resumo das correções: listas e formulários.', path: path('frontend/README-slides-listas-formularios.md') },
  { type: 'html-css', category: 'readme', title: 'README estrutura de projeto', desc: 'Resumo das correções: estrutura de projeto.', path: path('frontend/README-slides-estrutura-projeto.md') },
  { type: 'html-css', category: 'readme', title: 'README revisão HTML/CSS', desc: 'Resumo das correções: revisão HTML/CSS.', path: path('frontend/README-slides-revisao-html-css.md') },
  { type: 'html-css', category: 'readme', title: 'README CSS camada de estilo', desc: 'Resumo das correções: CSS camada de estilo.', path: path('frontend/README-slides-css-camada-estilo.md') },
  { type: 'html-css', category: 'readme', title: 'README box model e grid', desc: 'Resumo das correções: box model e grid.', path: path('frontend/README-slides-box-model-grid.md') },
  { type: 'html-css', category: 'readme', title: 'README flexbox', desc: 'Resumo das correções: flexbox.', path: path('frontend/README-slides-flexbox.md') },
  { type: 'html-css', category: 'readme', title: 'README landing page', desc: 'Resumo das correções: landing page.', path: path('frontend/README-slides-landing-page.md') },
  { type: 'html-css', category: 'relatorio', title: 'Relatório geral', desc: 'Todas as correções e melhorias nos 8 documentos.', path: path('frontend/RELATORIO.md') },
